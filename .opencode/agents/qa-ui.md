---
description: "Mobile QA flow planner for the Auxi React Native app. Authors deterministic Maestro YAML flows under auxi/maestro/flows/ with explicit UI state assertions. Does NOT execute flows (that's qa-mobile)..."
mode: subagent
tools:
  read: true
  bash: true
